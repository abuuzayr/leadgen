app.controller('contactsMainController', ['$scope', '$window', 'leadsData', 'historyData', 'mailListData', 'contactsColumnData', '$http', '$interval', 'uiGridConstants', '$q', '$location', '$timeout', 'feedbackServices', function($scope, $window, leadsData, historyData, mailListData, contactsColumnData, $http, $interval, uiGridConstants, $q, $location, $timeout, feedbackServices) {
    ...
    cc.gridOptions = {
        ...
        importerDataAddCallback: function(grid, newObjects) {
            ...
            var importStatus = $http.post("http://10.4.1.145/api/contacts/leadList/import", newObjects);
            cc.addFeedback();
        },
        onRegisterApi: function(gridApi) {
            ...
            gridApi.edit.on.afterCellEdit($scope, function(rowEntity, colDef, newValue, oldValue) {
                ...
                var editStatus = $http.patch("http://10.4.1.145/api/contacts/leadList/leads", editData);
    ...
    cc.addData = function() {
        ...
        var addStatus = $http.post("http://10.4.1.145/api/contacts/leadList/leads", lead);
    };
    ...
    cc.deleteSelected = function() {
        ...
        var deleteStatus = $http.put("http://10.4.1.145/api/contacts/leadList/leads", leads);
        $window.location.reload();
    };
   ...
   cc.addField = function() {
        ...
        var addStatus = $http.post("http://10.4.1.145/api/contacts/leadList/fields", field);
        $window.location.reload();
    };
    ...
    cc.deleteField = function() {
        for (var x in cc.gridOptions.columnDefs) {
            if ((cc.gridOptions.columnDefs[x].displayName === cc.selectedDeleteField)) {
                ...
                var deleteStatus = $http.put("http://10.4.1.145/api/contacts/leadList/fields", fieldObj);
                $window.location.reload();
            }
        }
    };
    ...
    cc.addToMailingList = function() {
        ...
        console.log(obj);
        var addStatus = $http.post("http://10.4.1.145/api/contacts/mailingList/subscriber", obj);
    };
    ...
    cc.removeDuplicate = function() {
        ...
        var removeStatus = $http.put("http://10.4.1.145/api/contacts/leadList/leads/duplicates", fieldObj);
        $window.location.reload();
    };
